...
% Mutlak farkdaki random gürültü median filtre ile temizlenir.
...
% imagesc(MutlakFark);
% figure(4)
% imagesc(MutlakFarkFilt)
% figure(5)
% imagesc(HareketliBolge)
% figure(6)
% imshow(Ih)
end